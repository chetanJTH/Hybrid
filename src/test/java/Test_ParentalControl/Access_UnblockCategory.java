...
public class Access_UnblockCategory extends Home {
    public Access_UnblockCategory(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void AccessUnblockCategoryTest() throws InterruptedException, NoSuchElementException {
        test = ExtentReport.shared().getExtentTest("Access unblock category");
        ...
        WebElement email = (WebElement) driver.findElement(By.xpath("//a[@title='About Always Fun Casinos']"));

        if (email.isDisplayed()) {
//            email.sendKeys("chetan");
            Log.addLog("category is unblocked");
        } else  {
