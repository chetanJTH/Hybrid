...
public class Thirty_Device_Web_Supervision extends Home {
    public Thirty_Device_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void ThirtyDeviceWebSupervisionTest() throws InterruptedException, NoSuchElementException {
