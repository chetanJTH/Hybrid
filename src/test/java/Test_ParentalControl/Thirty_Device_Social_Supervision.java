...
public class Thirty_Device_Social_Supervision extends Home {
    public Thirty_Device_Social_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void ThirtyDeviceSocialSupervisionTest() throws InterruptedException, NoSuchElementException {
