...
public class Fourteen_Web_Supervision extends Home {
    public Fourteen_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void FourteenWebSupervisionTest() throws InterruptedException, NoSuchElementException {
