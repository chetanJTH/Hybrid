...
public class Check_WebHistory extends Home {
    public Check_WebHistory(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void CheckWebHistoryTest() throws InterruptedException, NoSuchElementException {
        test = ExtentReport.shared().getExtentTest("Check device history");
        test.assignCategory("Regression");
        ParentalFactory P = new ParentalFactory(driver);
        WebDriverWait wait = new WebDriverWait(driver, 25);
        List<AndroidElement>  Website = driver.findElements(By.id("xunison.com.smarthomeapp:id/item_sv_web_history_site_tv"));
        List<AndroidElement>  Time = driver.findElements(By.id("xunison.com.smarthomeapp:id/item_sv_web_history_time_tv"));
