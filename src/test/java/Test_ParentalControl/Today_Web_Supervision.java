...
public class Today_Web_Supervision extends Home {
    public Today_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void TodayWebSupervisionTest() throws InterruptedException, NoSuchElementException {
       ...
       wait.until(ExpectedConditions.elementToBeClickable(P.Today));
