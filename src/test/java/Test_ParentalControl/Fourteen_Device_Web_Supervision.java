...
public class Fourteen_Device_Web_Supervision extends Home {
    public Fourteen_Device_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void FourteenDeviceWebSupervisionTest() throws InterruptedException, NoSuchElementException {
