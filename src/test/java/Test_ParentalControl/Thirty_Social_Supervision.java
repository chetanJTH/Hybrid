...
public class Thirty_Social_Supervision extends Home {
    public Thirty_Social_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void ThirtySocialSupervisionTest() throws InterruptedException, NoSuchElementException {
