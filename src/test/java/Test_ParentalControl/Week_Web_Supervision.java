...
public class Week_Web_Supervision extends Home {
    public Week_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void WeekWebSupervisionTest() throws InterruptedException, NoSuchElementException {
