...
public class Fourteen_Device_Social_Supervision extends Home {
    public Fourteen_Device_Social_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void FourteenDeviceSocialSupervisionTest() throws InterruptedException, NoSuchElementException {
