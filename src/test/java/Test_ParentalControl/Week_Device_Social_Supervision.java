...
public class Week_Device_Social_Supervision extends Home {
    public Week_Device_Social_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void WeekDeviceSocialSupervisionTest() throws InterruptedException, NoSuchElementException {
