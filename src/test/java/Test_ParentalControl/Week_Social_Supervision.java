...
public class Week_Social_Supervision extends Home {
    public Week_Social_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void WeekSocialSupervisionTest() throws InterruptedException, NoSuchElementException {
        test = ExtentReport.shared().getExtentTest("Week web supervision");
