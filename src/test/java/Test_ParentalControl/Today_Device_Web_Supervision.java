...
public class Today_Device_Web_Supervision extends Home {
    public Today_Device_Web_Supervision(AndroidDriver driver) {
        super(driver);
    }
    ...
    @Test
    public void TodayDeviceWebSupervisionTest() throws InterruptedException, NoSuchElementException {
        ...
        String el = "Galaxy-F41";



        findElement(scrollableList,el);

        driver.findElementByXPath("//android.widget.TextView[@text='Galaxy-F41']").click();
